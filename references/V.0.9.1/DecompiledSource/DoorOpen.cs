...
public class DoorOpen : MonoBehaviour
{
	...
	public void openDoor()
	{
		...
		if (closeOnly)
		{
			...
			{
				SoundManager.Instance.playASoundAtPoint(playOtherSoundToo, base.transform.position);
			}
		}
	}
	...
	public void playCloseSound()
	{
		...
		{
			SoundManager.Instance.playASoundAtPoint(altCloseSound, base.transform.position);
		}
		else
		{
			SoundManager.Instance.playASoundAtPoint(SoundManager.Instance.doorClose, base.transform.position);
		}
	}
	...
	public void playOpenSound()
	{
		...
		{
			SoundManager.Instance.playASoundAtPoint(altOpenSound, base.transform.position);
		}
		else
		{
			SoundManager.Instance.playASoundAtPoint(SoundManager.Instance.doorOpen, base.transform.position);
		}
	}
}
