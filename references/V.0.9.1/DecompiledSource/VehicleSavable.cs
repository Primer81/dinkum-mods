...
internal class VehicleSavable
{
	...
	public VehicleSavable(Vehicle toSave)
	{
		...
		VehicleStorage component = toSave.GetComponent<VehicleStorage>();
		if ((bool)component)
		{
			chestItems = component.invSlots;
			chestItemStack = component.invSlotStacks;
		}
	}
