...
public class moveHitPosToTileHighlighter : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (up && left)
		{
			base.transform.position = NetworkMapSharer.Instance.localChar.myInteract.tileHighlighter.position + base.transform.forward * 2f + -base.transform.right * 2f;
		}
		else if (up && right)
		{
			base.transform.position = NetworkMapSharer.Instance.localChar.myInteract.tileHighlighter.position + base.transform.forward * 2f + base.transform.right * 2f;
		...
		{
			base.transform.position = NetworkMapSharer.Instance.localChar.myInteract.tileHighlighter.position + base.transform.forward * 2f;
		}
		else if (down)
		{
			base.transform.position = NetworkMapSharer.Instance.localChar.myInteract.tileHighlighter.position + -base.transform.forward * 2f;
		...
		{
			base.transform.position = NetworkMapSharer.Instance.localChar.myInteract.tileHighlighter.position + -base.transform.right * 2f;
		}
		else if (right)
		{
			base.transform.position = NetworkMapSharer.Instance.localChar.myInteract.tileHighlighter.position + base.transform.right * 2f;
