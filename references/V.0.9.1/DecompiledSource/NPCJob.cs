...
public class NPCJob : NetworkBehaviour
{
	...
	public override void OnStartServer()
	{
		...
		if (myIdenity.NPCNo == 5 || myIdenity.NPCNo == 16 || myIdenity.NPCNo == 17)
		{
			NetworkatWork = true;
		}
		onChangeWork(atWork, atWork);
	...
	{
		if (atWork || myIdenity.NPCNo == 6 || !NPCManager.manage.npcStatus[myIdenity.NPCNo].hasMovedIn)
		{
			return false;
		}
		return NPCManager.manage.NPCDetails[myIdenity.NPCNo].mySchedual.checkIfLate(myIdenity.NPCNo);
	}
