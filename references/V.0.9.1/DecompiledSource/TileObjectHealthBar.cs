	...
	private void Update()
	{
		if (currentlyCanShow)
		{
			...
			else if ((bool)currentlyTracking)
			{
				...
				if (currentlyTracking.currentHealth < WorldManager.Instance.allObjectSettings[currentlyTracking.tileObjectId].fullHealth && currentlyTracking.currentHealth > 0f)
				{
					float num2 = currentlyShowingHealth;
					currentlyShowingHealth = currentlyTracking.currentHealth / WorldManager.Instance.allObjectSettings[currentlyTracking.tileObjectId].fullHealth;
