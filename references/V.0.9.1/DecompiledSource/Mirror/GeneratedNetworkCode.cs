...
public static class GeneratedNetworkCode
{
	...
	public static void _Write_HouseExterior(NetworkWriter writer, HouseExterior value)
	{
		if (value == null)
		{
		...
		writer.WriteInt(value.xPos);
		writer.WriteInt(value.yPos);
		writer.WriteBool(value.playerHouse);
		writer.WriteInt(value.houseLevel);
		writer.WriteInt(value.roof);
		writer.WriteInt(value.houseBase);
		writer.WriteInt(value.windows);
		writer.WriteInt(value.door);
		writer.WriteInt(value.fence);
		writer.WriteInt(value.wallMat);
		writer.WriteString(value.wallColor);
		writer.WriteInt(value.roofMat);
		writer.WriteString(value.roofColor);
		writer.WriteInt(value.houseMat);
		writer.WriteString(value.houseColor);
		writer.WriteString(value.houseName);
	}

	public static HouseExterior _Read_HouseExterior(NetworkReader reader)
	{
		if (!reader.ReadBool())
		{
			return null;
		}
		HouseExterior houseExterior = new HouseExterior();
		houseExterior.xPos = reader.ReadInt();
		houseExterior.yPos = reader.ReadInt();
		houseExterior.playerHouse = reader.ReadBool();
		houseExterior.houseLevel = reader.ReadInt();
		houseExterior.roof = reader.ReadInt();
		houseExterior.houseBase = reader.ReadInt();
		houseExterior.windows = reader.ReadInt();
		houseExterior.door = reader.ReadInt();
		houseExterior.fence = reader.ReadInt();
		houseExterior.wallMat = reader.ReadInt();
		houseExterior.wallColor = reader.ReadString();
		houseExterior.roofMat = reader.ReadInt();
		houseExterior.roofColor = reader.ReadString();
		houseExterior.houseMat = reader.ReadInt();
		houseExterior.houseColor = reader.ReadString();
		houseExterior.houseName = reader.ReadString();
		return houseExterior;
	}

	public static MapPoint _Read_MapPoint(NetworkReader reader)
	{
	...
	public static void _Write_MapPoint(NetworkWriter writer, MapPoint value)
	{
		writer.WriteInt(value.X);
		writer.WriteInt(value.Y);
	}

	public static WeatherData _Read_WeatherData(NetworkReader reader)
	{
		if (!reader.ReadBool())
		{
			return null;
		...
		weatherData.isOvercast = reader.ReadBool();
		weatherData.isRainy = reader.ReadBool();
		weatherData.isWindy = reader.ReadBool();
		weatherData.isStormy = reader.ReadBool();
		weatherData.isFoggy = reader.ReadBool();
		weatherData.isHeatWave = reader.ReadBool();
		weatherData.isMeteorShower = reader.ReadBool();
		weatherData.isSnowDay = reader.ReadBool();
		weatherData.windDirection = _Read_WindDirection(reader);
		return weatherData;
	}

	public static WindDirection _Read_WindDirection(NetworkReader reader)
	{
		WindDirection result = default(WindDirection);
		result.x = reader.ReadInt();
		result.z = reader.ReadInt();
		return result;
	}

	public static void _Write_WeatherData(NetworkWriter writer, WeatherData value)
	{
		if (value == null)
		{
			writer.WriteBool(value: false);
		...
		writer.WriteBool(value: true);
		writer.WriteBool(value.isOvercast);
		writer.WriteBool(value.isRainy);
		writer.WriteBool(value.isWindy);
		writer.WriteBool(value.isStormy);
		writer.WriteBool(value.isFoggy);
		writer.WriteBool(value.isHeatWave);
		writer.WriteBool(value.isMeteorShower);
		writer.WriteBool(value.isSnowDay);
		_Write_WindDirection(writer, value.windDirection);
	}

	public static void _Write_WindDirection(NetworkWriter writer, WindDirection value)
	{
		writer.WriteInt(value.x);
		writer.WriteInt(value.z);
	}

	public static void _Write_SignDetails_005B_005D(NetworkWriter writer, SignDetails[] value)
	{
		writer.WriteArray(value);
	}

	public static void _Write_SignDetails(NetworkWriter writer, SignDetails value)
	{
		if (value == null)
		{
			writer.WriteBool(value: false);
		...
		writer.WriteBool(value: true);
		writer.WriteString(value.signSays);
		writer.WriteInt(value.xPos);
		writer.WriteInt(value.yPos);
	...
	public static SignDetails[] _Read_SignDetails_005B_005D(NetworkReader reader)
	{
		return reader.ReadArray<SignDetails>();
	}

	public static SignDetails _Read_SignDetails(NetworkReader reader)
	{
		if (!reader.ReadBool())
		{
			return null;
		...
		signDetails.signSays = reader.ReadString();
		signDetails.xPos = reader.ReadInt();
		signDetails.yPos = reader.ReadInt();
		signDetails.houseX = reader.ReadInt();
		signDetails.houseY = reader.ReadInt();
		return signDetails;
	}
	...
	public static void InitReadWriters()
	{
		...
		Writer<HouseExterior>.write = _Write_HouseExterior;
		Writer<MapPoint>.write = _Write_MapPoint;
		Writer<WeatherData>.write = _Write_WeatherData;
		Writer<WindDirection>.write = _Write_WindDirection;
		Writer<SignDetails[]>.write = _Write_SignDetails_005B_005D;
		Writer<SignDetails>.write = _Write_SignDetails;
		...
		Reader<HouseExterior>.read = _Read_HouseExterior;
		Reader<MapPoint>.read = _Read_MapPoint;
		Reader<WeatherData>.read = _Read_WeatherData;
		Reader<WindDirection>.read = _Read_WindDirection;
		Reader<SignDetails[]>.read = _Read_SignDetails_005B_005D;
		Reader<SignDetails>.read = _Read_SignDetails;
