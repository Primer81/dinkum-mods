...
public class InputMaster : MonoBehaviour
{
	...
	public ControllerInputActions controls;
	...
	private void Start()
	{
		Input_Rebind.rebind.LoadBindings();
	}
	...
	{
		if (controls.Controls.OtherKeyboard.phase == InputActionPhase.Performed)
		{
			return UISelect();
		}
		return false;
	...
	{
		return controls.Controls.OtherKeyboard.phase == InputActionPhase.Performed;
	}
	...
	{
		return controls.Controls.Jump.phase == InputActionPhase.Performed;
	}
	...
	public bool UseHeld()
	{
		return controls.Controls.Use.phase == InputActionPhase.Performed;
	}
	...
	{
		return controls.UI.Select.phase == InputActionPhase.Performed;
	}
	...
	{
		return controls.UI.Cancel.phase == InputActionPhase.Performed;
	}
	...
	{
		return controls.UI.UIAlt.phase == InputActionPhase.Performed;
	}
	...
	public bool RBHeld()
	{
		return controls.Controls.RB.phase == InputActionPhase.Performed;
	}

	public bool LBHeld()
	{
		return controls.Controls.LB.phase == InputActionPhase.Performed;
	}
	...
	{
		return controls.Controls.TriggerLook.phase == InputActionPhase.Performed;
	}
	...
	public bool Whistle()
	{
		return controls.UI.Whistle.triggered;
	}

	public bool WhistleHeld()
	{
		return controls.UI.Whistle.phase == InputActionPhase.Performed;
	}

	public bool VoiceChatHeld()
	{
		return controls.UI.VC.phase == InputActionPhase.Performed;
	}

	public bool VoiceChatToggle()
	{
		return controls.UI.VC.triggered;
	}
	...
	{
		return controls.Controls.VehicleUse.phase == InputActionPhase.Performed;
	}
	...
	{
		return controls.Controls.VehicleInteract.phase == InputActionPhase.Performed;
	}

	public bool invSlotNumberPressed()
	{
		return controls.Controls.NumKeys.phase == InputActionPhase.Performed;
	}
	...
	{
		if (OptionsMenu.options.rumbleOn && !Inventory.Instance.usingMouse)
		{
	...
	private IEnumerator vehicleRumble(VehicleMakeParticles vehicle)
	{
		...
		if ((bool)vehicle)
		{
			while (NetworkMapSharer.Instance.localChar.myPickUp.drivingVehicle)
			{
				yield return true;
				if (Inventory.Instance.usingMouse)
				{
	...
	public void refreshInputOnSteamOverlay()
	{
