...
public class MilestoneManager : MonoBehaviour
{
	...
	public void refreshMilestoneAmounts()
	{
		...
		milestones[71].changeAmountPerLevel(new int[3] { 1, 5, 10 });
		milestones[71].changeRewardAmount(100);
		...
		milestones[64].changeRewardAmount(1000);
		...
		milestones[89].changeAmountPerLevel(new int[3] { 1, 10, 20 });
		milestones[89].changeRewardAmount(250);
		...
		milestones[97].changeAmountPerLevel(new int[7] { 5000, 20000, 100000, 250000, 500000, 1000000, 5000000 });
		milestones[97].changeRewardAmount(200);
		milestones[97].setSuffix("m");
		...
		milestones[90].changeAmountPerLevel(new int[4] { 1, 10, 20, 50 });
		milestones[90].changeRewardAmount(200);
		milestones[92].changeAmountPerLevel(new int[4] { 1, 10, 20, 50 });
		milestones[92].changeRewardAmount(200);
		milestones[93].changeAmountPerLevel(new int[4] { 1, 10, 20, 50 });
		milestones[93].changeRewardAmount(250);
		milestones[82].changeAmountPerLevel(new int[1] { 20 });
		milestones[82].changeRewardAmount(100);
		milestones[96].changeAmountPerLevel(new int[3] { 1, 2, 3 });
		milestones[96].changeRewardAmount(500);
		milestones[98].changeAmountPerLevel(new int[3] { 1, 2, 3 });
		milestones[98].changeRewardAmount(500);
		milestones[99].changeAmountPerLevel(new int[1] { 1 });
		milestones[99].changeRewardAmount(250);
		milestones[100].changeAmountPerLevel(new int[4] { 1, 10, 20, 50 });
		milestones[100].changeRewardAmount(500);
		milestones[101].changeAmountPerLevel(new int[1] { 1 });
		milestones[101].changeRewardAmount(500);
	}
	...
	{
		contentWindow.SetActive(value: false);
		lookingAt = toFill;
		...
		contentWindow.SetActive(value: true);
		openMilestoneClaimWindow();
	}

	public void openMilestoneClaimWindow()
	{
		milestoneClaimScreen.gameObject.SetActive(value: true);
		milestoneClaimWindowOpen = true;
	}

	public void closeMilestoneClaimWindow()
	{
		milestoneClaimScreen.gameObject.SetActive(value: false);
	...
	public void fillUnknowMilestoneDescription()
	{
		...
		fillText.text = "?? / <b>??";
		redeemParticles.SetActive(value: false);
		redeemButton.SetActive(value: false);
		contentWindow.SetActive(value: true);
	}

	public void pressRedeemButton()
	{
		SoundManager.Instance.play2DSound(playSoundOnComplete);
		lookingAt.levelUp();
