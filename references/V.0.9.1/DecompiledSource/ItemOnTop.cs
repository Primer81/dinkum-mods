...
public class ItemOnTop
{
	...
	public bool isAlreadyInList(ItemOnTop compareTo)
	{
		if (compareTo.sittingOnX == sittingOnX && compareTo.sittingOnY == sittingOnY && compareTo.houseX == houseX && compareTo.houseY == houseY && onTopPosition == compareTo.onTopPosition)
		{
			return true;
		}
		return false;
