...
public class AnimalCarryBox : NetworkBehaviour
{
	...
	{
		SoundManager.Instance.playASoundAtPoint(boxOpensSound, base.transform.position);
	}
	...
	public void RpcOpen()
	{
		...
		SendRPCInternal(typeof(AnimalCarryBox), "RpcOpen", writer, 0, includeOwner: true);
	...
	{
		myAnim.SetBool("Open", value: true);
