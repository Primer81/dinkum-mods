...
public class CutSceneScript : MonoBehaviour
{
	...
	private void OnEnable()
	{
		...
		canvasToTurnOff.SetActive(value: false);
	...
	private void Update()
	{
		if ((Inventory.Instance.usingMouse && InputMaster.input.UICancel()) || (!Inventory.Instance.usingMouse && InputMaster.input.OpenInventory()))
		{
			base.gameObject.SetActive(value: false);
		}
	}
	...
	{
		canvasToTurnOff.SetActive(value: true);
	...
	{
		PlayerAnim.gameObject.SetActive(value: false);
	}
