...
public class HouseSave
{
	...
	public string houseName = "Guest House";
	...
	public void correctStatusOfChangers()
	{
		for (int i = 0; i < 25; i++)
		{
			for (int j = 0; j < 25; j++)
			{
				if (houseMapOnTile[j, i] > 0 && (bool)WorldManager.Instance.allObjects[houseMapOnTile[j, i]].tileObjectItemChanger && houseMapOnTileStatus[j, i] == 0)
				{
