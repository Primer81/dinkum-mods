...
namespace Dinkum.API.Common;

//
// Summary:
//     Describes the type of a mod. Allows easy recognition and limiting of what any
//     particular mod can do.
public enum EnumModType
{
    //
    // Summary:
    //     Makes only theme changes (texture, shape, sound, music) to existing game or mod
    //     assets / content without adding new content or code.
    Theme,
    //
    // Summary:
    ...
    //
    // Summary:
    //     Can modify existing assets, add new content and make use of C# source files (.cs)
    //     and pre-compiled assemblies (.dll).
    Code
}
...
Load from: 'C:\Users\gwlar\.nuget\packages\newtonsoft.json\13.0.3\lib\net6.0\Newtonsoft.Json.dll'
------------------
